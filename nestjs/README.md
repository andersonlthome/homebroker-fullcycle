...
Utilização de Server Sent Events - servidor envia evento para o browser (http)
...
# Commands to do the application

Developed in Dev Container
...
// always when modify the schema.prisma
npx prisma generate
...
